...
const LAYER_GROUPS: LayerGroup[] = [
  ...
  { labelKey: 'layers.trends', ids: ['income_change', 'population_change', 'unemployment_change', 'property_price_change', 'crime_index_change'] },
  ...
  { labelKey: 'layers.housing', ids: ['ownership', 'rental', 'apt_size', 'living_space', 'detached_houses', 'new_construction', 'building_age', 'rental_price', 'price_to_rent'] },
