...
// QW-1: build-derived data-freshness timestamp, regenerated by `npm run build:data`.
    ...
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute left-0 top-full mt-2 w-56 rounded-xl bg-white dark:bg-surface-900
          ...
          {/* PO-6 / QW-1: Data freshness indicator — build-derived, not hardcoded */}
          {formatBuildDate(buildMetadata.generated, lang) && (
            <>
              <div className="border-t border-surface-100 dark:border-surface-700/40 my-1" />
              <div className="px-4 py-2 text-[10px] text-surface-400 dark:text-surface-500">
                {t('data.last_updated')}: {formatBuildDate(buildMetadata.generated, lang)}
              </div>
            </>
          )}
        </div>
