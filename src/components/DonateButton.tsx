...
// Lazy-load qrcode.react (~15KB) — QR code is only shown after user clicks
// "donate" then "show QR", so it should not be in the main bundle.
      ...
      {showQr && (
        <div className="flex justify-center mb-2">
          <div className="bg-white p-2 rounded-lg">
            <Suspense fallback={<div className="w-[160px] h-[160px] animate-pulse bg-surface-200 rounded" />}>
              <QRCodeSVG
                value={BOLT12_OFFER}
                size={160}
                level="L"
    ...
    >
      ...
      >
          ...
          {showQr && (
            <div className="flex justify-center mb-2">
              <div className="bg-white p-2 rounded-lg">
                <Suspense fallback={<div className="w-[180px] h-[180px] animate-pulse bg-surface-200 rounded" />}>
                  <QRCodeSVG
                    value={BOLT12_OFFER}
                    size={180}
                    level="L"
