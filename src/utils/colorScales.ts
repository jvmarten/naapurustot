 ...
 * the ramp itself rather than a straight fade between the endpoint colours — a two-stop
 * fade would silently drop every colour in between and no longer match the choropleth
 * the swatch is meant to explain.
 */
